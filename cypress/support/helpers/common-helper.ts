  ...
  public static generateValue(value: any): any {
    ...
    switch (newValue) {
      ...
      case "MARITAL_STATUS_FROM_API":
        result =
          CacheHelper.getInstance().getItem(CacheStorageKey.API_CONTACT)["maritalStatus"] === 1 ? "Single" : "Married";
        break;
      ...
      case "PREVIOUS_n_YEAR":
        result = DateTimeHelper.getDateWithFormat(
          DateTimeHelper.getDatePlusYear(DateTimeHelper.getDatePlusDay(-2), -seekNumber),
      ...
      case "NEXT_YEAR_FROM_TODAY":
        result = DateTimeHelper.getDateWithFormat(
          DateTimeHelper.getDatePlusYear(DateTimeHelper.getDatePlusDay(-1), 1),
          DateTimeHelper.COMMON_DATE_FORMAT,
        );
        break;
      case "NEXT_YEAR_FROM_TOMORROW":
        result = DateTimeHelper.getDateWithFormat(
          DateTimeHelper.getDatePlusYear(DateTimeHelper.getToday(), 1),
          DateTimeHelper.COMMON_DATE_FORMAT,
        );
        break;
      case "NEXT_YEAR_FROM_NEXT_n_DAY":
        result = DateTimeHelper.getDateWithFormat(
          DateTimeHelper.getDatePlusYear(DateTimeHelper.getDatePlusDay(seekNumber - 1), 1),
          DateTimeHelper.COMMON_DATE_FORMAT,
        );
        break;
      case "PHONE_NUMBER":
